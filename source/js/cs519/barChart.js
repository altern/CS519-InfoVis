function barChart() {
    ...
    var svg = d3.select('#visualization').append('div').attr('id', 'barChart').append('svg')
        .attr('class', 'chart')
        .attr('width', width)
        .attr('height', height)
      .append('g')
    ...
    var bars = svg.selectAll('.chart')
      ...
      .enter().append('rect')
        ...
        .attr('width', (width/data.length - 16))
    ...
    var labels = svg.selectAll('.chart') 
        ...
        .attr('x', function(d, i) { return i*(width/data.length - 16) + width/data.length/2 } )
        .attr('y', function (d, i) { return y(d.total/2)})
