...
function generateDataFromArtifactTree ( artifactTree, p ) {
    ...
    var experimentalBranches = parsedArtifactTree.experimentalBranches
        ...
        .map(function(a, i ) {
                return {
                    version: a.version, 
                    sequence: parseInt(a.parentObj.version), // TODO: replace this line
                    name: a.name
                } 
            })
